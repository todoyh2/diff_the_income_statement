 ...
 */
SnapshotService.createOrUpdateDailySnapshot = function (method) {
 ...
 * @returns {string} 期番号
 */
SnapshotService.extractTermNumber_ = function (sourceName) {
 ...
 */
SnapshotService.buildSnapshotName_ = function (term) {
 ...
 */
SnapshotService.writeMeta_ = function (sheet, sourceName, method) {
 ...
 */
SnapshotService.copySourceValues_ = function (source, snapshot) {
